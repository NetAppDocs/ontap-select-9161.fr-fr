...
== Installer une nouvelle instance de la machine virtuelle Deploy
...
== Restaurer les données de configuration de déploiement sur la nouvelle machine virtuelle
...
.Étapes
. Dans un shell de commande sur votre poste de travail local, utilisez l’utilitaire sftp pour télécharger le fichier de sauvegarde sur la machine virtuelle Deploy.
+
Exemple
