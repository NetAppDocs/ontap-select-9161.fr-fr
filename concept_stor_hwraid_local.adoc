...
NOTE: La surcharge VMFS est non nulle (VMware KB 1001618), et la tentative d'utiliser l'espace entier signalé comme libre par un datastore a entraîné des erreurs parasites lors des opérations de création de cluster.
