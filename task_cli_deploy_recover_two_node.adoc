...
* link:task_cli_migrate_deploy.html#restore-the-deploy-configuration-data-to-the-new-virtual-machine["Restaurer les données de configuration de déploiement sur la nouvelle machine virtuelle"]
* link:task_adm_licenses.html#reinstall-a-capacity-pool-license["Réinstaller une licence Capacity Pool"]
