...
*Haute fréquence cardiaque dans un cluster à quatre nœuds : état stable* image:DDHA_05.jpg["Battements de cœur HA dans un cluster à quatre nœuds : état stable"]
